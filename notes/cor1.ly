...
CredoCornoI = {
  \relative c' {
    ...
    \time 3/4 \tempoEtIncarnatus \newSpacingSection
      R2.*3
    \mvTr c2\pE^\markup \remark \transposedNameShort "cor" "F" "" r4 %75
    g g r
    R2.*3
    e'2.\fE %80
    d4 d2
    ...
    \time 4/4 \tempoEtResurrexit \newSpacingSection
      R1 \noBreak
    \pao \mvTr c'2\f^\markup \remark \transposedNameShort "cor" "D" "" c4 c
    g r r2 %105
    d' d4 d
    \pao c r r2
    R1
...
AgnusDeiCornoI = {
  \relative c' {
    ...
    R1*46 %108
    e'2^\markup \remark \transposedNameShort "cor" "D" "" d4 d
    c2 d4 g,8 c %110
    g4 r r2
    g4 d' g, r
    R1
