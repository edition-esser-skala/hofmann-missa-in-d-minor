...
GloriaClarinettoII = {
  \relative c' {
    ...
    \key a \minor \time 3/4 \tempoQuiTollis \newSpacingSection
      R2. \noBreak
    r8 \mvTr h\p_\transposedNameShort "cl" "B" "flat" h h h h
    R2.
    r8 c c c c c
    c4 h8 a gis e %65
    e4 r r
    ...
    \key f \major \time 4/4 \tempoQuoniam \newSpacingSection
      \mvTr b2\fE_\markup \remark \transposedNameShort "cl" "A" "" r
    es r
    c2. f,8 a
    b4 r r2
    b2. g8 h %110
...
CredoClarinettoII = {
  \relative c' {
    ...
    \once \override TextScript.X-offset = #3
      d2.\pE_\markup \remark \transposedNameShort "cl" "C" "" %75
    c2 r4
    R2.*2
    gis'2.\f
    a %80
    ...
    \key f \major \time 4/4 \tempoEtResurrexit \newSpacingSection
      R1 \noBreak
    \mvTr a2\f_\markup \remark \transposedNameShort "cl" "A" "" a4 a
    g r r2 %105
    c c4 c
    f r r2
    R1
...
BenedictusClarinettoII = {
  \relative c' {
    ...
    \mvTr a2.\f_\markup \remark \transposedNameShort "cl" "A" ""
    g
    f'2 f4
    f c e8 f
    e d c b a g %50
...
AgnusDeiClarinettoII = {
  \relative c' {
    ...
    \key f \major \time 4/4 \tempoDonaNobis
      R1*5 %67
    f2^\markup \remark \transposedNameShort "cl" "A" "" b4 b
    a8 f d' c h g e' d
